...
namespace LOP
{
    ...
    public class FlappyRaceRuleSystem : IGameRuleSystem
    {
        ...
        //  50Hz × 150초. 전원이 결승선을 넘으면 그 전에 끝나고, 이건 아무도 못 들어왔을 때의 상한이다.
        //  결승선(약 623m)까지 6.8m/s로 스턴 없이 92초라, 예전 비율(주행의 약 1.55배)대로 잡았다.
        //  남는 58초는 스턴(1.2초) 약 48번 분량이다.
        //  코스 길이나 전진 속도를 바꾸면 이 값도 같이 본다 — 90초로 두었다가 완주가 불가능해진 적이 있다.
        public long MatchDurationTicks => 7500;
